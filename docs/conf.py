...
latex_documents = [
  ('index', 'ddtpy.tex', u'DDTPy Documentation', authors, 'manual'),
]
...
man_pages = [
    ('index', 'DDTPy', u'DDTPy Documentation', authors.split(', '), 1)
]
...
texinfo_documents = [
  ('DDTPy', 'index', u'DDTPy Documentation',
   authors, 'DDTPy', 'One line description of project.',
   'Miscellaneous'),
]
